! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("ValinePure", [], t) : "object" == typeof exports ? exports.ValinePure = t() : e.ValinePure = t()
}(this, function() {
    return function(e) {
        function t(r) {
        ...
        function s(e) {
            return e && M.test(e) ? e.replace(_, function(e) {
                return w[e]
            }) : e
        }
        var a = function() {
                ...
                return a(e, [{
                    ...
                    value: function(e) {
                        ...
                        try {
                            ...
                            e.pageSize = isNaN(s) ? 10 : s < 1 ? 10 : s;
                            var a = AV;
                            ...
                            if (!l || !c) throw 100;
                            if (a.applicationId = null, a.init({
                                    appId: l,
                                    appKey: c
                                }), t.v = a, a)
                                for (var u = document.querySelectorAll(".valine-comment-count"), d = 0, h = u.length; d < h; d++) ! function(e, n) {
                                    var r = u[e];
                                    if (r) {
                            ...
                            var p = e.el || null;
                            if (!(p = "[object HTMLDivElement]" === {}.toString.call(p) ? p : document.querySelectorAll(p)[0] || null)) throw 99;
                            t.el = p, t.el.classList.add("v");
                            var f = {
                                ...
                                v = e.placeholder || "",
                                k = '<div class="vwrap"><div class="vheader item' + g.length + '">' + g.join("") + '</div><div class="vedit"><textarea class="veditor vinput" placeholder="' + v + '"></textarea></div><div class="vcontrol"><div class="col col-60" title="MarkDown is Support"><a href="https://segmentfault.com/markdown" target="_blank">MarkDown</a> is Support<div class="vlimit"></div></div><div class="col col-40 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><ul class="vlist"></ul><div class="vempty" style="display:none;"></div><div class="vpage txt-center" ></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v1.1.9-beta2</div></div>';
                            t.el.innerHTML = k;
                            ...
                            t.alert = {
                                show: function(e) {
                                    ...
                                    if (n.innerHTML = "" + r + (e && e.type && i), C.on("click", $.querySelector(".vcancel"), function(e) {
                                            t.alert.hide()
                                        }), $.setAttribute("style", "display:block;"), e && e.type) {
                                        var o = $.querySelector(".vsure");
                                        C.on("click", o, function(n) {
                    ...
                    value: function(e) {
                        var t = this,
                            n = function n() {
                                var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                                    o = e.pageSize,
                                    s = Number(t.el.querySelector(".vnum").innerText);
                                t.loading.show();
                                var a = t.Q(b.url);
                                a.limit(o), a.skip((i - 1) * o), a.find().then(function(e) {
                                    for (var a = e.length, l = 0; l < a; l++) r(e[l], !0);
                                    var c = t.el.querySelector(".vpage");
                                    c.innerHTML = o * i < s ? '<button type="button" class="vmore vbtn">' + t.locale.ctrl.more + "</button>" : "";
                                    var u = c.querySelector(".vmore");
                                    u && C.on("click", u, function(e) {
                                        c.innerHTML = "", n(++i)
                                    }), t.loading.hide()
                                }).catch(function(e) {
                        ...
                        for (var r = function(e, n) {
                                ...
                                var o = m.hide ? "" : '<img class="vimg" src=\'' + (m.cdn + (0, c.default)(e.get("mail")) + m.params) + "'>",
                                    s = (0, p.default)(e.get("ua")),
                                    a = '<span class="vsys">' + s.browser + " " + s.version + "</span>",
                                    l = '<span class="vsys">' + s.os + " " + s.osVersion + "</span>",
                                    u = "",
                                    d = e.get("link") || (e.get("mail") ? "mailto:" + e.get("mail") : "");
                                u = d ? '<a class="vname" rel="nofollow" href="' + d + '" target="_blank" >' + e.get("nick") + "</a>" : '<span class="vname">' + e.get("nick") + "</span>", r.innerHTML = o + '<section><div class="vhead">' + u + " " + a + " " + l + '</div><div class="vcontent">' + e.get("comment") + '</div><div class="vfooter"><span class="vtime">' + (0, g.default)(e.get("createdAt"), t.locale) + "</span><span rid='" + e.id + "' at='@" + e.get("nick") + "' mail='" + e.get("mail") + '\' class="vat">' + t.locale.ctrl.reply + "</span><div></section>";
                                for (var f = r.querySelector(".vat"), v = r.querySelectorAll("a"), b = 0, x = v.length; b < x; b++) {
                                    var y = v[b];
                                ...
                                setTimeout(function() {
                                    e.offsetHeight > 180 && (e.classList.add("expand"), C.on("click", e, function(t) {
                                ...
                                rid: "",
                                rmail: ""
                            }, l = e.guest_info, u = {}, h = function(e) {
                                C.on("click", e, function(t) {
                                    var n = e.getAttribute("at"),
                                        r = e.getAttribute("rid"),
                                        i = e.getAttribute("mail");
                                    a.at = o(n), a.rid = r, a.rmail = i, u.comment.value = n + " ", u.comment.focus()
                                })
                            }, f = {
                                veditor: "comment"
                        ...
                        for (var k in f) f.hasOwnProperty(k) && function() {
                            ...
                            u[e] = n, C.on("input", n, function(r) {
                                if ("comment" === e) {
                                    var i = n.value || "",
                                        s = i.substring(0, 1e4);
                                    t.el.querySelector(".vlimit").innerHTML = "" == i ? "" : t.locale.tips.limit.replace("%d", 1e4 - s.length), b[e] = (0, d.default)(s), n.value = s
                        ...
                        var w = function() {
                            ...
                            if (e) {
                                ...
                                for (var r in n) {
                                    var i = n[r];
                                    t.el.querySelector(".v" + i).value = s(e[i]), b[i] = e[i]
                                }
                            }
                        };
                        w();
                        var O = function() {
                                ...
                                a.at = "", a.rid = "", a.rmail = "", b.nick = "Anonymous", t.el.querySelector(".vlimit").innerHTML = "", w()
                            },
                            ...
                            $ = function(e) {
                                ...
                                if (b.nick = "" == b.nick ? "Anonymous" : b.nick, b.comment.indexOf(a.at) > -1 && "" != a.at) {
                                    var n = '<a class="at" href=\'#' + a.rid + "'>" + a.at + "</a>";
                                    b.comment = b.comment.replace(a.at, n)
                                }
                                var r = E.mail(b.mail),
                                    i = E.link(b.link);
                                b.mail = r.k ? r.v : "", b.link = i.k ? i.v : "", t.notify || t.verify ? M(_) : _()
                            },
                            A = function() {
                                var e = new t.v.ACL;
                            ...
                            _ = function() {
                                ...
                                n.setACL(A()), n.save().then(function(e) {
                                    "Guest" != b.nick && v && v.setItem("ValineCache", JSON.stringify({
                                        nick: b.nick,
                                        link: b.link,
                                        mail: b.mail
                                    }));
                                    var n = t.el.querySelector(".vnum"),
                                        i = 1;
                                    try {
                                        n ? (i = Number(n.innerText) + 1, n.innerText = i) : t.el.querySelector(".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments, r(e), b.mail && L({
                                            username: b.nick,
                                            mail: b.mail
                                        }), a.at && a.rmail && t.notify && q({
                                            username: a.at.replace("@", ""),
                                            mail: a.rmail
                        ...
                        C.off("click", S, $), C.on("click", S, $), C.on("keyup", document, function(e) {
        ...
        function r(e) {
            ...
            n.device = "PC", n.language = function() {
                var e = s.browserLanguage || s.language,
                    t = e.split("-");
        ...
        var r = function(e, t) {
                if (e) try {
                    ...
                    return s < 0 ? t.timeago.now : s < 8 ? s + " " + t.timeago.days : i(e)
                } catch (e) {}
            },
            i = function(e) {
                var t = o(e.getDate(), 2),
        ...
        ! function(i) {
            ...
            function v(e, t) {
                var n, r, i = f(e),
                    o = [],
                    s = [];
                for (o[15] = s[15] = void 0, i.length > 16 && (i = h(i, 8 * e.length)), n = 0; n < 16; n += 1) o[n] = 909522486 ^ i[n], s[n] = 1549556828 ^ i[n];
                return r = h(o.concat(f(t)), 512 + 8 * t.length), p(h(s.concat(r), 640))
            }
        ...
        (function(t) {
            (function() {
                ...
                function u(e, n, r) {
                    if (r || "function" == typeof n) {
                        ...
                        for (; d < s.length; d++) ! function(e) {
                            "code" !== e.type ? --a || h() : l(e.text, e.lang, function(t, n) {
                ...
                d.bullet = /(?:[*+-]|\d+\.)/, d.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, d.item = a(d.item, "gm")(/bull/g, d.bullet)(), d.list = a(d.list)(/bull/g, d.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + d.def.source + ")")(), d.blockquote = a(d.blockquote)("def", d.def)(), d._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", d.html = a(d.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, d._tag)(), d.paragraph = a(d.paragraph)("hr", d.hr)("heading", d.heading)("lheading", d.lheading)("blockquote", d.blockquote)("tag", "<" + d._tag)("def", d.def)(), d.normal = c({}, d), d.gfm = c({}, d.normal, {
                    ...
                    paragraph: /^/,
                    heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/
                }), d.gfm.paragraph = a(d.paragraph)("(?!", "(?!" + d.gfm.fences.source.replace("\\1", "\\2") + "|" + d.list.source.replace("\\1", "\\3") + "|")(), d.tables = c({}, d.gfm, {
                    nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
                    table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
                    ...
                    for (var r, i, o, s, a, l, c, u, h, e = e.replace(/^ +$/gm, ""); e;)
                ...
                h._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/, h._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, h.link = a(h.link)("inside", h._inside)("href", h._href)(), h.reflink = a(h.reflink)("inside", h._inside)(), h.normal = c({}, h), h.pedantic = c({}, h.normal, {
